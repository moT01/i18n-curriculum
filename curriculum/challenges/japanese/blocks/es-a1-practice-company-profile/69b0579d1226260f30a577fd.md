...
This is not the correct number of employees.
...
The verb `tiene` is the third person form of the verb `tener` ("to have") because it refers to `la empresa`. For example:
