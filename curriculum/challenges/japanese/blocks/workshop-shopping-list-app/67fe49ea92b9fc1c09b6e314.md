...
assert.match(shoppingListString, /filteredItems\s*=\s*items\.filter\(\s*(?:function\s*\(\s*item\s*\)\s*\{\s*return\s+|\(?\s*item\s*\)?\s*=>\s*)item\.toLowerCase\(\)\.includes\(/);
...
assert.match(shoppingListString, /filteredItems\s*=\s*items\.filter\(\s*(?:function\s*\(\s*item\s*\)\s*\{\s*return\s+|\(?\s*item\s*\)?\s*=>\s*)item\.toLowerCase\(\)\.includes\(\s*query\.toLowerCase\(\)\s*\)/);
