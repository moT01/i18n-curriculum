...
`resetGame` 関数は `playerScore` を `0` に設定する必要があります。
...
`resetGame` 関数は `computerScore` を `0` に設定する必要があります。
...
`resetGame` 関数は `playerScoreSpanElement` を `0` に設定する必要があります。
...
`resetGame` 関数は `computerScoreSpanElement` を `0` に設定する必要があります。
...
`resetGame` 関数は `roundResultsMsg` を空の文字列に設定する必要があります。
...
`resetGame` 関数は `winnerMsgElement` を空の文字列に設定する必要があります。
...
`resetGame` 関数は `resetGameBtn` を非表示にする必要があります。
...
`resetGame` 関数は `optionsContainer` を表示する必要があります。
