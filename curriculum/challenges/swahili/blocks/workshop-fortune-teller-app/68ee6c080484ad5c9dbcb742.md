...
Now you will start creating the methods.

Create a method called `singleCardSelected`. Inside it, call the `hideElements` function and pass the following properties: `singleCardBtn`, `multipleCardsBtn`, `multipleCard`, `text`, and `headerTitle`.

Remember you must access all of them using `this.elements`.

# --hints--

You should define a method named `singleCardSelected`.

```js
const explorer = await __helpers.Explorer(code);
const method = explorer.classes.Game.methods.singleCardSelected;
assert.isFalse(method.isEmpty());
```

Inside `singleCardSelected`, you should call the `hideElements` function.

```js
const explorer = await __helpers.Explorer(code);
const method = explorer.classes.Game.methods.singleCardSelected.toString();
assert.match(method, /hideElements\s*\(/);
```

You should pass `singleCardBtn` to the `hideElements` function.

```js
const explorer = await __helpers.Explorer(code);
const method = explorer.classes.Game.methods.singleCardSelected.toString();
assert.match(method, /hideElements\s*\([\s\S]*?this\.elements\.singleCardBtn/);
```

You should pass `multipleCardsBtn` to the `hideElements` function.

```js
const explorer = await __helpers.Explorer(code);
const method = explorer.classes.Game.methods.singleCardSelected.toString();
assert.match(method, /hideElements\s*\([\s\S]*?this\.elements\.multipleCardsBtn/);
```

You should pass `multipleCard` to the `hideElements` function.
...
You should pass `text` to the `hideElements` function.

```js
const explorer = await __helpers.Explorer(code);
const method = explorer.classes.Game.methods.singleCardSelected.toString();
assert.match(method, /hideElements\s*\([\s\S]*?this\.elements\.text\b/);
```

You should pass `headerTitle` to the `hideElements` function.

```js
const explorer = await __helpers.Explorer(code);
const method = explorer.classes.Game.methods.singleCardSelected.toString();
assert.match(method, /hideElements\s*\([\s\S]*?this\.elements\.headerTitle/);
```
