...
This practice task will help you review how to identify basic information about a company in Spanish.
...
`Es` is the third-person singular of the verb `ser` ("to be"). When describing what a company is, you should use this structure in Spanish:
