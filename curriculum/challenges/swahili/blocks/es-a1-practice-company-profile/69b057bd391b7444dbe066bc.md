...
This task doesn't have audio. Review the dialogue and use the following words: `dónde`, `cómo`, `está`, `trabajas`, `tiene` to complete the sentences below. You may write the same word multiple times.
