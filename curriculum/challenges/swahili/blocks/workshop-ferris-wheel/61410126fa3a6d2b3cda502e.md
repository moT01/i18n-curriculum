...
Badilisha `linear` kuwa `ease-in-out` katika kichaguzi cha `.cabin`.

# --hints--

Kichaguzi chako cha `.cabin` kinafaa kuwa na sifa ya `animation` iliyowekwa kuwa `cabins 10s ease-in-out infinite`.
