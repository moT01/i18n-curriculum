...
Ondoa maandishi ya kishika nafasi kutoka kwa kipengele cha kwanza cha `input`, ukitegemea `label` kuwa mbinu bora zaidi.

# --hints--

Unapaswa kuondoa `placeholder` kutoka kwa kipengele cha kwanza cha `input`.
