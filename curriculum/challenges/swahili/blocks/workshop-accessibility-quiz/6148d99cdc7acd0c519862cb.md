...
Unapaswa kutumia kichaguzi cha `.info label` au `.info > label`.
...
Unapaswa kuvipa vipengele vya `label` `width` ya `10%`.
...
Unapaswa kuvipa vipengele vya `label` `min-width` ya `55px`.
