...
Mit diesen letzten Änderungen ist deine Nährwertkennzeichnung vollständig!

# --hints--

Dein `.note`-Selektor sollte die `padding`-Eigenschaft auf `0 8px` gesetzt haben.
...
Dein `.note` Selektor sollte eine `text-indent` Eigenschaft auf `-8px` gesetzt haben.
