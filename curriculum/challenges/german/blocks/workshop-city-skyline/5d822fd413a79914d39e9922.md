...
Gib dem `.fb3a` Element eine `width` von `80%` und eine `height` von `15%`. Dann gib dem `.fb3b` Element eine `width` von `100%` und eine `height` von `35%`.

# --hints--

Du solltest `.fb3a` eine `width` von `80%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb3a")?.width, "80%");
```

Du solltest `.fb3a` eine `height` von `15%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb3a")?.height, "15%");
```

Du solltest `.fb3b` eine `width` von `100%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb3b")?.width, "100%");
```

Du solltest `.fb3b` eine `height` von `35%` geben.
