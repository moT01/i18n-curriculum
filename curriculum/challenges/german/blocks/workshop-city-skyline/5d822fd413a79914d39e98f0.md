...
In a previous module you learned that gradients in CSS are a way to transition between colors across the distance of an element. Sie werden an der `background`-Eigenschaft angewendet und die Syntax sieht folgendermaßen aus:
