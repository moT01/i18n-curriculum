...
Gib `.fb1b` eine `width` von `60%` und eine `height` von `10%`, und `.fb1c` eine `width` von `100%` und eine `height` von `80%`.

# --hints--

Du solltest `.fb1b` eine `width` von `60%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb1b")?.width, "60%");
```

Du solltest `.fb1b` eine `height` von `10%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb1b")?.height, "10%");
```

Du solltest `.fb1c` eine `width` von `100%` geben.

```js
assert.equal(new __helpers.CSSHelp(document).getStyle(".fb1c")?.width, "100%");
```

Du solltest `.fb1c` eine `height` von `80%` geben.
