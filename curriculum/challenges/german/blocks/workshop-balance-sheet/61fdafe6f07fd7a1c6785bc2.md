...
Dein `span[class~="sr-only"]`-Selektor sollte eine `position`-Eigenschaft auf `absolute` gesetzt haben.
...
Dein `span[class~="sr-only"]`-Selektor sollte eine `padding`-Eigenschaft auf `0` gesetzt haben.
...
Dein `span[class~="sr-only"]`-Selektor sollte eine `margin`-Eigenschaft auf `-1px` gesetzt haben.
