...
Now, do the same for the rest of the properties. Use the `getElement` function to select each one:

| Property             | Selector               |
| -------------------- | ---------------------- |
| `multipleCardsBtn`   | `#btn-multiple-cards`  |
| `multipleCard`       | `.multiple_card`       |
| `title`              | `.title`               |
| `newReadingBtn`      | `.btn_reveal`          |
| `fortuneContainer`   | `.fortune_container`   |
| `fortuneDescription` | `.fortune_description` |
| `headerTitle`        | `.header_title`        |
| `subTitle`           | `.sub_title`           |
| `cardTitle`          | `.desc_title`          |
...
You should access the `multipleCardsBtn` by using the `getElement` method and passing `#btn-multiple-cards`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /multipleCardsBtn:\s*getElement\(['"]#btn-multiple-cards['"]\)/);
```

You should access the `multipleCard` by using the `getElement` method and passing `.multiple_card`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /multipleCard:\s*getElement\(['"]\.\s*multiple_card['"]\)/);
```

You should access the `title` by using the `getElement` method and passing `.title`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /title:\s*getElement\(['"]\.title['"]\)/);
```

You should access the `newReadingBtn` by using the `getElement` method and passing `.btn_reveal`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /newReadingBtn:\s*getElement\(['"]\.btn_reveal['"]\)/);
```

You should access the `fortuneContainer` by using the `getElement` method and passing `.fortune_container`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /fortuneContainer:\s*getElement\(['"]\.fortune_container['"]\)/);
```

You should access the `fortuneDescription` by using the `getElement` method and passing `.fortune_description`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /fortuneDescription:\s*getElement\(['"]\.fortune_description['"]\)/);
```

You should access the `headerTitle` by using the `getElement` method and passing `.header_title`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /headerTitle:\s*getElement\(['"]\.header_title['"]\)/);
```

You should access the `subTitle` by using the `getElement` method and passing `.sub_title`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /subTitle:\s*getElement\(['"]\.sub_title['"]\)/);
```

You should access the `cardTitle` by using the `getElement` method and passing `.desc_title`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /cardTitle:\s*getElement\(['"]\.desc_title['"]\)/);
```

You should access the `description` by using the `getElement` method and passing `.description`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /description:\s*getElement\(['"]\.description['"]\)/);
```

You should access the `text` by using the `getElement` method and passing `.text`.

```js
const explorer = await __helpers.Explorer(code);
const constructor = explorer.classes.Game.classConstructor.toString();
assert.match(constructor, /text:\s*getElement\(['"]\.text['"]\)/);
```
