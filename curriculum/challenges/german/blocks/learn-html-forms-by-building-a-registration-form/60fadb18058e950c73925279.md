...
Entferne die `border` und füge `2rem` an Padding nur am oberen und unteren Rand jedes `fieldset` hinzu. Achte darauf, das `padding` von links und rechts zu entfernen.
