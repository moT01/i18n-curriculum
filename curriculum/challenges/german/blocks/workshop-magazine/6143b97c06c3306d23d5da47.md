...
Innerhald des `article` Elements erstelle ein `h3` Element mit der `class` `list-title` und dem Text von `A Brief History`. Erstelle darunter ein `p`-Element mit dem Text `Of the Curriculum`. Erstelle dann ein `ul` mit der Klasse `lists`.
