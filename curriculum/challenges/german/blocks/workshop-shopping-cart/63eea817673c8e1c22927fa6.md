...
Du solltest die Destrukturierung verwenden, um die `name`- und `price`-Variablen zu erhalten.
...
Du solltest `const` verwenden, um die `name`- und `price`-Variablen zu deklarieren.
