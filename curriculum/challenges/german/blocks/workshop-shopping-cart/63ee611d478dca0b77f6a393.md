...
Du solltest das `this`-Schlüsselwort verwenden, um die `items`-Eigenschaft deiner Klasse auf ein leeres Array zu setzen.
...
Du solltest das `this`-Schlüsselwort verwenden, um die `total`-Eigenschaft deiner Klasse auf `0` zu setzen.
...
Du solltest das `this`-Schlüsselwort verwenden, um die `taxRate`-Eigenschaft deiner Klasse auf `8.25` zu setzen.
