...
Die letzte Funktion besteht darin, dass die Nutzer ihren Einkaufswagen leeren können. Füge eine `clearCart()`-Methode zu deiner `ShoppingCart`-Klasse hinzu.

# --hints--

Deine `ShoppingCart`-Klasse sollte über eine `clearCart`-Methode verfügen.
