...
Finally, inside the `hideElements`, pass the arguments `singleCard`, `multipleCard`, `fortuneContainer`, and `fortuneDescription`. Remember to get them from the elements.
