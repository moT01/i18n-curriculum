...
You have already seen the verb `tiene`, which comes from the verb `tener` ("to have"). Now take a look at this verb in context. For example:
...
Therefore, the department has twelve employees, not twenty-one employees.
