...
Every feature needs a roadmap and a leader to ensure deadlines are met.

Sebastián is mentioning the department that coordinates the "what" and the "when" of a release.
...
Sebastián mentions `Producto y gestión de proyectos`. This means "Product and project management".
